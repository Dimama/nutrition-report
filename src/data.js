...
const ration = ['Без проблем', 'Регулярно, но разные объемы порций', 'Обычные порции, но нерегулярно',
  'Минимально регулярно', 'Минимально нерегулярно', 'Отсутствует', 'Избыточное питание'];
